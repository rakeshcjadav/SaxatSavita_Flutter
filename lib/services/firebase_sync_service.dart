...
class FirebaseSyncService implements FirebaseSyncServiceBase {
  ...
  Future<void> syncReadingEvent(ReadingEvent event) =>
      _impl.syncReadingEvent(event);

  @override
  Future<void> deleteReadingEvent(String eventId) =>
      _impl.deleteReadingEvent(eventId);

  @override
  Future<void> loadReadingEvents() => _impl.loadReadingEvents();

  @override
  Future<void> syncQuizResult(KiranQuizResult result) =>
      _impl.syncQuizResult(result);
  ...
  Future<void> syncDailyQuizResult(DailyQuizResult result) =>
      _impl.syncDailyQuizResult(result);
